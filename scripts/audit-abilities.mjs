...
import abilityGameplay from './ability-gameplay.js';
...
const report={revision:abilityGameplay.revision,total:abilities.length,
 gameplay:{adapted:abilities.filter(ab=>ab.mechanics?.gameplayRevision===abilityGameplay.revision).length,manual:abilities.filter(ab=>ab.mechanics?.mode==='manual').length},
